...
- [x] [TASK-106 — Modelar schema local (Drift)](TASK-106-modelar-schema-local-drift.md) — Flutter Senior
- [x] [TASK-107 — Criar pacote de carga offline](TASK-107-criar-pacote-de-carga-offline.md) — Flutter Senior
...
- [x] [TASK-116 — Implementar dashboard de atingimento](TASK-116-implementar-dashboard-de-atingimento.md) — Flutter Senior + Front-end
...
- [x] [TASK-124 — Implementar insight de cliente em crescimento](TASK-124-implementar-insight-de-cliente-em-crescimento.md) — Flutter Senior
- [x] [TASK-125 — Implementar insight de cross-sell](TASK-125-implementar-insight-de-cross-sell.md) — Flutter Senior
- [x] [TASK-126 — Implementar insight de up-sell](TASK-126-implementar-insight-de-up-sell.md) — Flutter Senior
- [x] [TASK-127 — Implementar insight de mix insuficiente](TASK-127-implementar-insight-de-mix-insuficiente.md) — Flutter Senior
- [x] [TASK-128 — Implementar insight de estoque alto/giro baixo e reposição](TASK-128-implementar-insight-de-estoque-e-reposicao.md) — Flutter Senior
- [x] [TASK-129 — Implementar insight de risco de churn](TASK-129-implementar-insight-de-risco-de-churn.md) — Flutter Senior
- [x] [TASK-130 — Implementar insight de pedido abandonado/carrinho salvo](TASK-130-implementar-insight-de-pedido-abandonado.md) — Flutter Senior
- [x] [TASK-131 — Implementar insight de vendedor abaixo da meta](TASK-131-implementar-insight-de-vendedor-abaixo-da-meta.md) — Flutter Senior
- [x] [TASK-132 — Implementar central de oportunidades](TASK-132-implementar-central-de-oportunidades.md) — Flutter Senior + Front-end
...
- [x] [TASK-135 — Implementar dashboard de vendas](TASK-135-implementar-dashboard-de-vendas.md) — Flutter Senior + Front-end
- [x] [TASK-136 — Implementar dashboard de clientes](TASK-136-implementar-dashboard-de-clientes.md) — Flutter Senior + Front-end
...
- [x] [TASK-174 — Implementar suporte a multi-idioma](TASK-174-implementar-suporte-multi-idioma.md) — Flutter Senior + Front-end
- [x] [TASK-175 — Implementar suporte a multi-moeda](TASK-175-implementar-suporte-multi-moeda.md) — Flutter Senior
...
- [x] [TASK-178 — Implementar check-in de visita](TASK-178-implementar-check-in-de-visita.md) — Flutter Senior + Front-end
...
- [x] [TASK-190 — Implementar recomendação de produtos baseada em comportamento](TASK-190-implementar-recomendacao-comportamental.md) — Flutter Senior
- [x] [TASK-191 — Implementar reconhecimento de produto por imagem](TASK-191-implementar-reconhecimento-de-produto-por-imagem.md) — Flutter Senior
- [x] [TASK-192 — Implementar criação assistida de coleção/campanha (IA)](TASK-192-implementar-criacao-assistida-de-campanha.md) — Flutter Senior + Front-end
...
- [x] [TASK-196 — Implementar políticas comerciais avançadas](TASK-196-implementar-politicas-comerciais-avancadas.md) — Flutter Senior
- [x] [TASK-197 — Implementar orçamento (cotação) antes do pedido](TASK-197-implementar-orcamento-antes-do-pedido.md) — Flutter Senior + Front-end
- [x] [TASK-198 — Implementar pedido recorrente](TASK-198-implementar-pedido-recorrente.md) — Flutter Senior + Front-end
...
- [x] [TASK-211 — Implementar colaboração com comprador em seleções e pedidos](TASK-211-implementar-colaboracao-com-comprador.md) — Flutter Senior + Front-end
- [x] [TASK-212 — Implementar crédito, inadimplência e bloqueios financeiros](TASK-212-implementar-credito-inadimplencia-e-bloqueios.md) — Flutter Senior + Front-end
- [x] [TASK-213 — Implementar contas a receber, faturas e lembretes de cobrança](TASK-213-implementar-contas-a-receber-faturas-e-cobranca.md) — Flutter Senior + Front-end
...
- [x] [TASK-218 — Implementar territórios, cobertura e potencial de carteira](TASK-218-implementar-territorios-cobertura-e-potencial-de-carteira.md) — Flutter Senior + Front-end
- [x] [TASK-219 — Implementar ingestão de sell-out/POS do varejo](TASK-219-implementar-ingestao-de-sell-out-pos.md) — Flutter Senior
- [x] [TASK-220 — Implementar governança de dados mestre e qualidade cadastral](TASK-220-implementar-governanca-de-dados-mestre-e-qualidade-cadastral.md) — Flutter Senior + Front-end

---

**Progresso:** 216 / 216 tasks concluídas (TASK-166, TASK-204, TASK-205 e TASK-206 foram movidas
para o backlog — ver
[`docs/backlog/BACKLOG-005-realizar-release-mvp-controlado.md`](../backlog/BACKLOG-005-realizar-release-mvp-controlado.md),
[`docs/backlog/BACKLOG-006-implementar-logs-de-auditoria-exportaveis.md`](../backlog/BACKLOG-006-implementar-logs-de-auditoria-exportaveis.md),
