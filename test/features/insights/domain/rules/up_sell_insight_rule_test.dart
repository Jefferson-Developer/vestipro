...
void main() {
  group('UpSellInsightRule', () {
    ...
    test('fires when the customer sits below the higher-volume comparison '
    ...
    test('does not fire when the customer is already at or above the '
    ...
    test('does not fire when the gap is below the configured minimum relevant '
    ...
    test('caps the suggested additional quantity by the real available stock '
        'of the variant', () {
      final context = contextWith(<InsightUpSellSnapshot>[
        const InsightUpSellSnapshot(
    ...
    test('does not fire when every variant candidate in the category has no '
