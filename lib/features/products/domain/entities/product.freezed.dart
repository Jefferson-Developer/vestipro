...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Product&&(identical(other.id, id) || other.id == id)&&(identical(other.organizationId, organizationId) || other.organizationId == organizationId)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.sku, sku) || other.sku == sku)&&(identical(other.reference, reference) || other.reference == reference)&&(identical(other.name, name) || other.name == name)&&(identical(other.shortDescription, shortDescription) || other.shortDescription == shortDescription)&&(identical(other.fullDescription, fullDescription) || other.fullDescription == fullDescription)&&(identical(other.brand, brand) || other.brand == brand)&&(identical(other.collectionId, collectionId) || other.collectionId == collectionId)&&(identical(other.seasonId, seasonId) || other.seasonId == seasonId)&&(identical(other.line, line) || other.line == line)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.subcategoryId, subcategoryId) || other.subcategoryId == subcategoryId)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.targetAudience, targetAudience) || other.targetAudience == targetAudience)&&(identical(other.fabric, fabric) || other.fabric == fabric)&&(identical(other.composition, composition) || other.composition == composition)&&(identical(other.supplierId, supplierId) || other.supplierId == supplierId)&&(identical(other.ncm, ncm) || other.ncm == ncm)&&(identical(other.ean, ean) || other.ean == ean)&&const DeepCollectionEquality().equals(other.tags, tags)&&const DeepCollectionEquality().equals(other.colorIds, colorIds)&&(identical(other.sizeGridTemplateId, sizeGridTemplateId) || other.sizeGridTemplateId == sizeGridTemplateId)&&(identical(other.status, status) || other.status == status)&&(identical(other.launchDate, launchDate) || other.launchDate == launchDate)&&(identical(other.seoTitle, seoTitle) || other.seoTitle == seoTitle)&&(identical(other.seoDescription, seoDescription) || other.seoDescription == seoDescription)&&(identical(other.seoSlug, seoSlug) || other.seoSlug == seoSlug)&&const DeepCollectionEquality().equals(other.media, media)&&const DeepCollectionEquality().equals(other.customFieldValues, customFieldValues)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.updatedBy, updatedBy) || other.updatedBy == updatedBy)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&(identical(other.version, version) || other.version == version)&&(identical(other.syncStatus, syncStatus) || other.syncStatus == syncStatus));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,organizationId,companyId,sku,reference,name,shortDescription,fullDescription,brand,collectionId,seasonId,line,categoryId,subcategoryId,gender,targetAudience,fabric,composition,supplierId,ncm,ean,const DeepCollectionEquality().hash(tags),const DeepCollectionEquality().hash(colorIds),sizeGridTemplateId,status,launchDate,seoTitle,seoDescription,seoSlug,const DeepCollectionEquality().hash(media),const DeepCollectionEquality().hash(customFieldValues),createdAt,createdBy,updatedAt,updatedBy,deletedAt,version,syncStatus]);

@override
String toString() {
  return 'Product(id: $id, organizationId: $organizationId, companyId: $companyId, sku: $sku, reference: $reference, name: $name, shortDescription: $shortDescription, fullDescription: $fullDescription, brand: $brand, collectionId: $collectionId, seasonId: $seasonId, line: $line, categoryId: $categoryId, subcategoryId: $subcategoryId, gender: $gender, targetAudience: $targetAudience, fabric: $fabric, composition: $composition, supplierId: $supplierId, ncm: $ncm, ean: $ean, tags: $tags, colorIds: $colorIds, sizeGridTemplateId: $sizeGridTemplateId, status: $status, launchDate: $launchDate, seoTitle: $seoTitle, seoDescription: $seoDescription, seoSlug: $seoSlug, media: $media, customFieldValues: $customFieldValues, createdAt: $createdAt, createdBy: $createdBy, updatedAt: $updatedAt, updatedBy: $updatedBy, deletedAt: $deletedAt, version: $version, syncStatus: $syncStatus)';
}
...
@useResult
$Res call({
 String id, String organizationId, String? companyId, Sku sku, String reference, String name, String? shortDescription, String? fullDescription, String? brand, String? collectionId, String? seasonId, String? line, String? categoryId, String? subcategoryId, ProductGender? gender, TargetAudience? targetAudience, String? fabric, String? composition, String? supplierId, String? ncm, Ean? ean, List<String> tags, List<String> colorIds, String? sizeGridTemplateId, ProductStatus status, DateTime? launchDate, String? seoTitle, String? seoDescription, String? seoSlug, List<ProductMedia> media, List<ProductCustomFieldValue> customFieldValues, DateTime createdAt, String createdBy, DateTime updatedAt, String updatedBy, DateTime? deletedAt, int version, ProductSyncStatus syncStatus
});
...
as List<String>,colorIds: null == colorIds ? _self.colorIds : colorIds // ignore: cast_nullable_to_non_nullable
as List<String>,sizeGridTemplateId: freezed == sizeGridTemplateId ? _self.sizeGridTemplateId : sizeGridTemplateId // ignore: cast_nullable_to_non_nullable
...
as List<ProductMedia>,customFieldValues: null == customFieldValues ? _self.customFieldValues : customFieldValues // ignore: cast_nullable_to_non_nullable
...
class _Product extends Product {
  const _Product({required this.id, required this.organizationId, this.companyId, required this.sku, required this.reference, required this.name, this.shortDescription, this.fullDescription, this.brand, this.collectionId, this.seasonId, this.line, this.categoryId, this.subcategoryId, this.gender, this.targetAudience, this.fabric, this.composition, this.supplierId, this.ncm, this.ean, final  List<String> tags = const <String>[], final  List<String> colorIds = const <String>[], this.sizeGridTemplateId, required this.status, this.launchDate, this.seoTitle, this.seoDescription, this.seoSlug, final  List<ProductMedia> media = const <ProductMedia>[], final  List<ProductCustomFieldValue> customFieldValues = const <ProductCustomFieldValue>[], required this.createdAt, required this.createdBy, required this.updatedAt, required this.updatedBy, this.deletedAt, required this.version, required this.syncStatus}): _tags = tags,_colorIds = colorIds,_media = media,_customFieldValues = customFieldValues,super._();
...
@override@JsonKey() List<String> get colorIds {
...
@override@JsonKey() List<ProductMedia> get media {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Product&&(identical(other.id, id) || other.id == id)&&(identical(other.organizationId, organizationId) || other.organizationId == organizationId)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.sku, sku) || other.sku == sku)&&(identical(other.reference, reference) || other.reference == reference)&&(identical(other.name, name) || other.name == name)&&(identical(other.shortDescription, shortDescription) || other.shortDescription == shortDescription)&&(identical(other.fullDescription, fullDescription) || other.fullDescription == fullDescription)&&(identical(other.brand, brand) || other.brand == brand)&&(identical(other.collectionId, collectionId) || other.collectionId == collectionId)&&(identical(other.seasonId, seasonId) || other.seasonId == seasonId)&&(identical(other.line, line) || other.line == line)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.subcategoryId, subcategoryId) || other.subcategoryId == subcategoryId)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.targetAudience, targetAudience) || other.targetAudience == targetAudience)&&(identical(other.fabric, fabric) || other.fabric == fabric)&&(identical(other.composition, composition) || other.composition == composition)&&(identical(other.supplierId, supplierId) || other.supplierId == supplierId)&&(identical(other.ncm, ncm) || other.ncm == ncm)&&(identical(other.ean, ean) || other.ean == ean)&&const DeepCollectionEquality().equals(other._tags, _tags)&&const DeepCollectionEquality().equals(other._colorIds, _colorIds)&&(identical(other.sizeGridTemplateId, sizeGridTemplateId) || other.sizeGridTemplateId == sizeGridTemplateId)&&(identical(other.status, status) || other.status == status)&&(identical(other.launchDate, launchDate) || other.launchDate == launchDate)&&(identical(other.seoTitle, seoTitle) || other.seoTitle == seoTitle)&&(identical(other.seoDescription, seoDescription) || other.seoDescription == seoDescription)&&(identical(other.seoSlug, seoSlug) || other.seoSlug == seoSlug)&&const DeepCollectionEquality().equals(other._media, _media)&&const DeepCollectionEquality().equals(other._customFieldValues, _customFieldValues)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.updatedBy, updatedBy) || other.updatedBy == updatedBy)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&(identical(other.version, version) || other.version == version)&&(identical(other.syncStatus, syncStatus) || other.syncStatus == syncStatus));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,organizationId,companyId,sku,reference,name,shortDescription,fullDescription,brand,collectionId,seasonId,line,categoryId,subcategoryId,gender,targetAudience,fabric,composition,supplierId,ncm,ean,const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_colorIds),sizeGridTemplateId,status,launchDate,seoTitle,seoDescription,seoSlug,const DeepCollectionEquality().hash(_media),const DeepCollectionEquality().hash(_customFieldValues),createdAt,createdBy,updatedAt,updatedBy,deletedAt,version,syncStatus]);
...
as List<String>,colorIds: null == colorIds ? _self._colorIds : colorIds // ignore: cast_nullable_to_non_nullable
as List<String>,sizeGridTemplateId: freezed == sizeGridTemplateId ? _self.sizeGridTemplateId : sizeGridTemplateId // ignore: cast_nullable_to_non_nullable
as String?,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as ProductStatus,launchDate: freezed == launchDate ? _self.launchDate : launchDate // ignore: cast_nullable_to_non_nullable
as DateTime?,seoTitle: freezed == seoTitle ? _self.seoTitle : seoTitle // ignore: cast_nullable_to_non_nullable
...
as List<ProductMedia>,customFieldValues: null == customFieldValues ? _self._customFieldValues : customFieldValues // ignore: cast_nullable_to_non_nullable
as List<ProductCustomFieldValue>,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,createdBy: null == createdBy ? _self.createdBy : createdBy // ignore: cast_nullable_to_non_nullable
as String,updatedAt: null == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime,updatedBy: null == updatedBy ? _self.updatedBy : updatedBy // ignore: cast_nullable_to_non_nullable
