...
@useResult
$Res call({
 String id, String organizationId, String? companyId, Sku sku, String reference, String name, String? shortDescription, String? fullDescription, String? brand, String? collectionId, String? seasonId, String? line, String? categoryId, String? subcategoryId, ProductGender? gender, TargetAudience? targetAudience, String? fabric, String? composition, String? supplierId, String? ncm, Ean? ean, List<String> tags, List<String> colorIds, ProductStatus status, DateTime? launchDate, String? seoTitle, String? seoDescription, String? seoSlug, List<ProductMedia> media, List<ProductCustomFieldValue> customFieldValues, DateTime createdAt, String createdBy, DateTime updatedAt, String updatedBy, DateTime? deletedAt, int version, ProductSyncStatus syncStatus
});
...
@override
int get hashCode => Object.hashAll([runtimeType,id,organizationId,companyId,sku,reference,name,shortDescription,fullDescription,brand,collectionId,seasonId,line,categoryId,subcategoryId,gender,targetAudience,fabric,composition,supplierId,ncm,ean,const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_colorIds),status,launchDate,seoTitle,seoDescription,seoSlug,const DeepCollectionEquality().hash(_media),const DeepCollectionEquality().hash(_customFieldValues),createdAt,createdBy,updatedAt,updatedBy,deletedAt,version,syncStatus]);
