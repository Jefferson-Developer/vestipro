...
final class OpportunityMapper {
  ...
  Opportunity toEntity(OpportunityDto dto) {
    return Opportunity(
      ...
      stageId: dto.stageId,
      outcomeFromStageId: dto.outcomeFromStageId,
      status: statusToEntity(dto.status),
      expectedCloseDate: dto.expectedCloseDate,
      wonReasonId: dto.wonReasonId,
      wonReason: dto.wonReason,
      wonReasonNote: dto.wonReasonNote,
      lostReasonId: dto.lostReasonId,
      lostReason: dto.lostReason,
      lostReasonNote: dto.lostReasonNote,
  ...
  OpportunityDto toDto(Opportunity entity) {
    return OpportunityDto(
      ...
      outcomeFromStageId: entity.outcomeFromStageId,
      status: statusToDto(entity.status),
      expectedCloseDate: entity.expectedCloseDate,
      wonReasonId: entity.wonReasonId,
      wonReason: entity.wonReason,
      wonReasonNote: entity.wonReasonNote,
      lostReasonId: entity.lostReasonId,
      lostReason: entity.lostReason,
      lostReasonNote: entity.lostReasonNote,
