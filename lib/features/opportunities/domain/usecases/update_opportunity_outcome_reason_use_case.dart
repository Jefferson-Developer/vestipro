...
@injectable
final class UpdateOpportunityOutcomeReasonUseCase {
  UpdateOpportunityOutcomeReasonUseCase(this._repository);
  ...
  Future<AppResult<OpportunityOutcomeReason>> call({
    ...
    if (fieldErrors.isNotEmpty) {
      return AppFailure<OpportunityOutcomeReason>(
        ValidationFailure(
          'Invalid opportunity outcome reason update payload.',
          fieldErrors: fieldErrors,
          code: 'invalid_opportunity_outcome_reason_update_payload',
        ),
      );
    }
    ...
    return _repository.update(reason: updated);
  }
}
