...
mixin _$Customer {
 ...
 String get id; String get organizationId; String get companyId; CustomerType get type; CnpjCpf get document; String? get legalName; String? get tradeName; String? get fullName; String? get stateRegistration; String? get primaryEmail; String? get primaryPhone; CustomerStatus get status; String? get classification; String? get potential; String? get segment; String? get originChannel; String? get responsibleSellerId; DateTime get registeredAt; DateTime? get lastPurchaseAt; List<String> get tags; Map<String, Object?> get customFields; DateTime get createdAt; String get createdBy; DateTime get updatedAt; String get updatedBy; DateTime? get deletedAt; int get version; CustomerSyncStatus get syncStatus;
...
switch (_that) {
case _Customer() when $default != null:
return $default(_that.id,_that.organizationId,_that.companyId,_that.type,_that.document,_that.legalName,_that.tradeName,_that.fullName,_that.stateRegistration,_that.primaryEmail,_that.primaryPhone,_that.status,_that.classification,_that.potential,_that.segment,_that.originChannel,_that.responsibleSellerId,_that.registeredAt,_that.lastPurchaseAt,_that.tags,_that.customFields,_that.createdAt,_that.createdBy,_that.updatedAt,_that.updatedBy,_that.deletedAt,_that.version,_that.syncStatus);case _:
  return orElse();
...
class _Customer extends Customer {
  const _Customer({required this.id, required this.organizationId, required this.companyId, required this.type, required this.document, this.legalName, this.tradeName, this.fullName, this.stateRegistration, this.primaryEmail, this.primaryPhone, required this.status, this.classification, this.potential, this.segment, this.originChannel, this.responsibleSellerId, required this.registeredAt, this.lastPurchaseAt, final  List<String> tags = const <String>[], final  Map<String, Object?> customFields = const <String, Object?>{}, required this.createdAt, required this.createdBy, required this.updatedAt, required this.updatedBy, this.deletedAt, required this.version, required this.syncStatus}): _tags = tags,_customFields = customFields,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Customer&&(identical(other.id, id) || other.id == id)&&(identical(other.organizationId, organizationId) || other.organizationId == organizationId)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.type, type) || other.type == type)&&(identical(other.document, document) || other.document == document)&&(identical(other.legalName, legalName) || other.legalName == legalName)&&(identical(other.tradeName, tradeName) || other.tradeName == tradeName)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.stateRegistration, stateRegistration) || other.stateRegistration == stateRegistration)&&(identical(other.primaryEmail, primaryEmail) || other.primaryEmail == primaryEmail)&&(identical(other.primaryPhone, primaryPhone) || other.primaryPhone == primaryPhone)&&(identical(other.status, status) || other.status == status)&&(identical(other.classification, classification) || other.classification == classification)&&(identical(other.potential, potential) || other.potential == potential)&&(identical(other.segment, segment) || other.segment == segment)&&(identical(other.originChannel, originChannel) || other.originChannel == originChannel)&&(identical(other.responsibleSellerId, responsibleSellerId) || other.responsibleSellerId == responsibleSellerId)&&(identical(other.registeredAt, registeredAt) || other.registeredAt == registeredAt)&&(identical(other.lastPurchaseAt, lastPurchaseAt) || other.lastPurchaseAt == lastPurchaseAt)&&const DeepCollectionEquality().equals(other._tags, _tags)&&const DeepCollectionEquality().equals(other._customFields, _customFields)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.updatedBy, updatedBy) || other.updatedBy == updatedBy)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&(identical(other.version, version) || other.version == version)&&(identical(other.syncStatus, syncStatus) || other.syncStatus == syncStatus));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,organizationId,companyId,type,document,legalName,tradeName,fullName,stateRegistration,primaryEmail,primaryPhone,status,classification,potential,segment,originChannel,responsibleSellerId,registeredAt,lastPurchaseAt,const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_customFields),createdAt,createdBy,updatedAt,updatedBy,deletedAt,version,syncStatus]);
