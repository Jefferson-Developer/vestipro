...
// Customer was created through `ConvertLeadToCustomerUseCase`.
 String? get sourceLeadId; DateTime get registeredAt; DateTime? get lastPurchaseAt; int? get commercialScore; int? get healthScore; CustomerHealthScoreBand? get healthScoreBand; DateTime? get scoreUpdatedAt; String? get scoreFormulaVersion; CustomerScoreDataCoverage? get scoreDataCoverage; List<CustomerAddress> get addresses; List<CustomerContact> get contacts; List<String> get tags; Map<String, Object?> get customFields; DateTime get createdAt; String get createdBy; DateTime get updatedAt; String get updatedBy; DateTime? get deletedAt; int get version; CustomerSyncStatus get syncStatus;
...
as DateTime?,commercialScore: freezed == commercialScore ? _self.commercialScore : commercialScore // ignore: cast_nullable_to_non_nullable
as int?,healthScore: freezed == healthScore ? _self.healthScore : healthScore // ignore: cast_nullable_to_non_nullable
as int?,healthScoreBand: freezed == healthScoreBand ? _self.healthScoreBand : healthScoreBand // ignore: cast_nullable_to_non_nullable
as CustomerHealthScoreBand?,scoreUpdatedAt: freezed == scoreUpdatedAt ? _self.scoreUpdatedAt : scoreUpdatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,scoreFormulaVersion: freezed == scoreFormulaVersion ? _self.scoreFormulaVersion : scoreFormulaVersion // ignore: cast_nullable_to_non_nullable
as String?,scoreDataCoverage: freezed == scoreDataCoverage ? _self.scoreDataCoverage : scoreDataCoverage // ignore: cast_nullable_to_non_nullable
as CustomerScoreDataCoverage?,addresses: null == addresses ? _self.addresses : addresses // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Customer() when $default != null:
return $default(_that.id,_that.organizationId,_that.companyId,_that.type,_that.document,_that.legalName,_that.tradeName,_that.fullName,_that.stateRegistration,_that.primaryEmail,_that.primaryPhone,_that.status,_that.classification,_that.potential,_that.segment,_that.originChannel,_that.responsibleSellerId,_that.sourceLeadId,_that.registeredAt,_that.lastPurchaseAt,_that.commercialScore,_that.healthScore,_that.healthScoreBand,_that.scoreUpdatedAt,_that.scoreFormulaVersion,_that.scoreDataCoverage,_that.addresses,_that.contacts,_that.tags,_that.customFields,_that.createdAt,_that.createdBy,_that.updatedAt,_that.updatedBy,_that.deletedAt,_that.version,_that.syncStatus);case _:
  return orElse();
...
@override final  int? commercialScore;
@override final  int? healthScore;
@override final  CustomerHealthScoreBand? healthScoreBand;
@override final  DateTime? scoreUpdatedAt;
@override final  String? scoreFormulaVersion;
@override final  CustomerScoreDataCoverage? scoreDataCoverage;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Customer&&(identical(other.id, id) || other.id == id)&&(identical(other.organizationId, organizationId) || other.organizationId == organizationId)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.type, type) || other.type == type)&&(identical(other.document, document) || other.document == document)&&(identical(other.legalName, legalName) || other.legalName == legalName)&&(identical(other.tradeName, tradeName) || other.tradeName == tradeName)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.stateRegistration, stateRegistration) || other.stateRegistration == stateRegistration)&&(identical(other.primaryEmail, primaryEmail) || other.primaryEmail == primaryEmail)&&(identical(other.primaryPhone, primaryPhone) || other.primaryPhone == primaryPhone)&&(identical(other.status, status) || other.status == status)&&(identical(other.classification, classification) || other.classification == classification)&&(identical(other.potential, potential) || other.potential == potential)&&(identical(other.segment, segment) || other.segment == segment)&&(identical(other.originChannel, originChannel) || other.originChannel == originChannel)&&(identical(other.responsibleSellerId, responsibleSellerId) || other.responsibleSellerId == responsibleSellerId)&&(identical(other.sourceLeadId, sourceLeadId) || other.sourceLeadId == sourceLeadId)&&(identical(other.registeredAt, registeredAt) || other.registeredAt == registeredAt)&&(identical(other.lastPurchaseAt, lastPurchaseAt) || other.lastPurchaseAt == lastPurchaseAt)&&(identical(other.commercialScore, commercialScore) || other.commercialScore == commercialScore)&&(identical(other.healthScore, healthScore) || other.healthScore == healthScore)&&(identical(other.healthScoreBand, healthScoreBand) || other.healthScoreBand == healthScoreBand)&&(identical(other.scoreUpdatedAt, scoreUpdatedAt) || other.scoreUpdatedAt == scoreUpdatedAt)&&(identical(other.scoreFormulaVersion, scoreFormulaVersion) || other.scoreFormulaVersion == scoreFormulaVersion)&&(identical(other.scoreDataCoverage, scoreDataCoverage) || other.scoreDataCoverage == scoreDataCoverage)&&const DeepCollectionEquality().equals(other._addresses, _addresses)&&const DeepCollectionEquality().equals(other._contacts, _contacts)&&const DeepCollectionEquality().equals(other._tags, _tags)&&const DeepCollectionEquality().equals(other._customFields, _customFields)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.updatedBy, updatedBy) || other.updatedBy == updatedBy)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt)&&(identical(other.version, version) || other.version == version)&&(identical(other.syncStatus, syncStatus) || other.syncStatus == syncStatus));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,organizationId,companyId,type,document,legalName,tradeName,fullName,stateRegistration,primaryEmail,primaryPhone,status,classification,potential,segment,originChannel,responsibleSellerId,sourceLeadId,registeredAt,lastPurchaseAt,commercialScore,healthScore,healthScoreBand,scoreUpdatedAt,scoreFormulaVersion,scoreDataCoverage,const DeepCollectionEquality().hash(_addresses),const DeepCollectionEquality().hash(_contacts),const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_customFields),createdAt,createdBy,updatedAt,updatedBy,deletedAt,version,syncStatus]);
...
as DateTime?,scoreFormulaVersion: freezed == scoreFormulaVersion ? _self.scoreFormulaVersion : scoreFormulaVersion // ignore: cast_nullable_to_non_nullable
as String?,scoreDataCoverage: freezed == scoreDataCoverage ? _self.scoreDataCoverage : scoreDataCoverage // ignore: cast_nullable_to_non_nullable
as CustomerScoreDataCoverage?,addresses: null == addresses ? _self._addresses : addresses // ignore: cast_nullable_to_non_nullable
