...
switch (_that) {
case _Customer() when $default != null:
return $default(_that.id,_that.organizationId,_that.companyId,_that.type,_that.document,_that.legalName,_that.tradeName,_that.fullName,_that.stateRegistration,_that.primaryEmail,_that.primaryPhone,_that.status,_that.classification,_that.potential,_that.segment,_that.originChannel,_that.responsibleSellerId,_that.registeredAt,_that.lastPurchaseAt,_that.addresses,_that.contacts,_that.tags,_that.customFields,_that.createdAt,_that.createdBy,_that.updatedAt,_that.updatedBy,_that.deletedAt,_that.version,_that.syncStatus);case _:
  return orElse();
...
@override
int get hashCode => Object.hashAll([runtimeType,id,organizationId,companyId,type,document,legalName,tradeName,fullName,stateRegistration,primaryEmail,primaryPhone,status,classification,potential,segment,originChannel,responsibleSellerId,registeredAt,lastPurchaseAt,const DeepCollectionEquality().hash(_addresses),const DeepCollectionEquality().hash(_contacts),const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_customFields),createdAt,createdBy,updatedAt,updatedBy,deletedAt,version,syncStatus]);
