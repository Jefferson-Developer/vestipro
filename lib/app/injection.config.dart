...
import '../core/notifications/domain/usecases/mark_notification_as_read_use_case.dart'
    as _i421;
import '../core/notifications/domain/usecases/resolve_notification_delivery_time_use_case.dart'
    as _i1015;
...
import '../core/notifications/domain/usecases/should_dispatch_notification_use_case.dart'
    as _i876;
import '../core/notifications/domain/usecases/sync_device_timezone_use_case.dart'
    as _i973;
...
import '../core/notifications/push/device_installation_id_provider.dart'
    as _i10;
import '../core/notifications/push/device_timezone_provider.dart' as _i274;
...
import '../features/visit_routes/data/repositories/drift_visit_route_repository.dart'
    as _i652;
import '../features/visit_routes/domain/repositories/visit_route_repository.dart'
    as _i860;
import '../features/visit_routes/domain/services/route_optimization_service.dart'
    as _i833;
import '../features/visit_routes/domain/usecases/build_visit_route_use_case.dart'
    as _i981;
import '../features/visit_routes/domain/usecases/get_active_visit_route_use_case.dart'
    as _i222;
import '../features/visit_routes/domain/usecases/mark_visit_route_stop_status_use_case.dart'
    as _i540;
import '../features/visit_routes/domain/usecases/reorder_visit_route_stops_use_case.dart'
    as _i514;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i58.VisitRouteLocalMapper>(
      () => const _i58.VisitRouteLocalMapper(),
    );
    ...
    gh.lazySingleton<_i274.DeviceTimezoneProvider>(
      () => const _i274.SystemDeviceTimezoneProvider(),
    );
    ...
    gh.lazySingleton<_i860.VisitRouteRepository>(
      () => _i652.DriftVisitRouteRepository(
        gh<_i658.AppDatabase>(),
        gh<_i58.VisitRouteLocalMapper>(),
      ),
    );
    ...
    gh.factory<_i222.GetActiveVisitRouteUseCase>(
      () => _i222.GetActiveVisitRouteUseCase(gh<_i860.VisitRouteRepository>()),
    );
    gh.factory<_i540.MarkVisitRouteStopStatusUseCase>(
      () => _i540.MarkVisitRouteStopStatusUseCase(
        gh<_i860.VisitRouteRepository>(),
      ),
    );
    gh.factory<_i514.ReorderVisitRouteStopsUseCase>(
      () =>
          _i514.ReorderVisitRouteStopsUseCase(gh<_i860.VisitRouteRepository>()),
    );
    ...
    gh.factory<_i833.RouteOptimizationService>(
      () => _i833.RouteOptimizationService(
        averageSpeedKmh: gh<double>(),
        maxStops: gh<int>(),
      ),
    );
    ...
    gh.factory<_i981.BuildVisitRouteUseCase>(
      () => _i981.BuildVisitRouteUseCase(
        gh<_i860.VisitRouteRepository>(),
        gh<_i833.RouteOptimizationService>(),
      ),
    );
    ...
    gh.factory<_i106.LoadProductDashboardRankingUseCase>(
      () => _i106.LoadProductDashboardRankingUseCase(
        gh<_i649.AggregationRepository>(),
        gh<_i41.ResolveApplicablePriceListsUseCase>(),
        gh<_i101.PriceListItemRepository>(),
      ),
    ...
    gh.factory<_i973.SyncDeviceTimezoneUseCase>(
      () => _i973.SyncDeviceTimezoneUseCase(
        gh<_i693.CommunicationPreferencesRepository>(),
        gh<_i274.DeviceTimezoneProvider>(),
      ),
    );
    ...
    gh.factory<_i532.ProcessCrmTaskReminderUseCase>(
      () => _i532.ProcessCrmTaskReminderUseCase(
        ...
        gh<_i387.ResolveNotificationDeliveryTimeUseCase>(),
        gh<_i202.AnalyticsService>(),
      ),
    );
    ...
    gh.factory<_i261.ProductDashboardBloc>(
      () => _i261.ProductDashboardBloc(
        gh<_i846.ExecutiveDashboardVisibilityService>(),
        gh<_i106.LoadProductDashboardRankingUseCase>(),
        gh<_i675.BuildProductDashboardSnapshotUseCase>(),
        gh<_i799.CompanyRepository>(),
        gh<_i626.CollectionRepository>(),
